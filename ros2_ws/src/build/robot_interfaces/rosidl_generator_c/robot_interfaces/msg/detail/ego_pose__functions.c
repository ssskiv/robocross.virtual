...
robot_interfaces__msg__EgoPose__create()
{
  ...
  robot_interfaces__msg__EgoPose * msg = (robot_interfaces__msg__EgoPose *)allocator.allocate(sizeof(robot_interfaces__msg__EgoPose), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_interfaces__msg__EgoPose));
  bool success = robot_interfaces__msg__EgoPose__init(msg);
  if (!success) {
...
robot_interfaces__msg__EgoPose__destroy(robot_interfaces__msg__EgoPose * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    robot_interfaces__msg__EgoPose__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
robot_interfaces__msg__EgoPose__Sequence__init(robot_interfaces__msg__EgoPose__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_interfaces__msg__EgoPose * data = NULL;

  if (size) {
    data = (robot_interfaces__msg__EgoPose *)allocator.zero_allocate(size, sizeof(robot_interfaces__msg__EgoPose), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_interfaces__msg__EgoPose__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robot_interfaces__msg__EgoPose__fini(&data[i - 1]);
      }
...
robot_interfaces__msg__EgoPose__Sequence__fini(robot_interfaces__msg__EgoPose__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_interfaces__msg__EgoPose__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_interfaces__msg__EgoPose__Sequence * array = (robot_interfaces__msg__EgoPose__Sequence *)allocator.allocate(sizeof(robot_interfaces__msg__EgoPose__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_interfaces__msg__EgoPose__Sequence__init(array, size);
  if (!success) {
...
robot_interfaces__msg__EgoPose__Sequence__destroy(robot_interfaces__msg__EgoPose__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_interfaces__msg__EgoPose__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robot_interfaces__msg__EgoPose__Sequence__are_equal(const robot_interfaces__msg__EgoPose__Sequence * lhs, const robot_interfaces__msg__EgoPose__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_interfaces__msg__EgoPose__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robot_interfaces__msg__EgoPose__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_interfaces__msg__EgoPose);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_interfaces__msg__EgoPose * data =
      (robot_interfaces__msg__EgoPose *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_interfaces__msg__EgoPose__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_interfaces__msg__EgoPose__fini(&output->data[i]);
        }
        return false;
      }
    }
