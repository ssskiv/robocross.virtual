...
bool robot_interfaces__msg__ego_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._ego_pose.EgoPose", full_classname_dest, 38) == 0);
  }
  robot_interfaces__msg__EgoPose * ros_message = _ros_message;
  {  // lat
...
{
  /* NOTE(esteve): Call constructor of EgoPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._ego_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EgoPose");
